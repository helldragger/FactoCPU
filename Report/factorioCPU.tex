...
\begin{document}
    ...
    \subsection{Le combinateur logique}
	    ...
	    \section{Le language}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-instruction.png}
	    ...
	    \section{Le processeur d'instructions}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-regINSTR.png}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-regPC.png}
...
WIRE mem regA; READ mem; WRITE regA; -- write data from mem to regA
	    ...
	    \section{La manipulation de données}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-regA.png}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-regV.png}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-regVmask.png}
	    	...
	    	\begin{figure}[h]
	    		\centering
	    		\includegraphics[width=0.8\linewidth]{pics/factorio-diag-ALU.png}
